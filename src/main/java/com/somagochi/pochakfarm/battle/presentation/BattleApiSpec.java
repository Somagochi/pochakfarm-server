  ...
  @Operation(
      ...
      description =
          "NPC 관장 8명을 도전 순서 오름차순으로 조회한다. "
              + "목록에는 썸네일과 클리어 여부, 해금 여부와 요구 레벨·직전 관장 뱃지 두 해금 조건의 충족 여부를 내려주고, "
  ...
  @Operation(
      ...
      description =
          "관장 1명과 관장 동물 3마리를 조회한다. "
              ...
              + "관장 동물은 이미지·이름·출전 순서·티어·타입과 보유 스킬 2개를 공개한다. "
              + "스킬은 이름과 전투 유형만 내려주고 발동 확률과 승부 포인트는 포함하지 않는다.")
  @SecurityRequirement(name = "bearerAuth")
  @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "조회 성공")
  @io.swagger.v3.oas.annotations.responses.ApiResponse(
      responseCode = "401",
  ...
  @Operation(
      ...
      description =
          "내 동물 3마리와 출전 순서를 편성해 관장전을 시작한다. "
              ...
              + "1번 출전 동물의 티어·타입 상성을 바로 판정하고 적용된 승부 바 위치와 중계 이벤트를 저장한다. "
              + "응답의 관장 동물에는 보유 스킬의 이름과 전투 유형이 포함된다. "
